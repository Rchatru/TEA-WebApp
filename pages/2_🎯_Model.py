...
col_1.image('static/Images/resultados_txt.png',caption='Métricas de entrenamiento, test y validación', use_column_width=False,width=350)
col_2.image('static/Images/confusion_func.png',caption='Matriz de confusión normalizada', use_column_width=False,width=440)
